...
public class DefaultInputHandler extends InputHandler {
  ...
  public void addDefaultKeyBindings() {
    ...
    // Program
    addKeyBinding("C+O", ActionManager.getInstance().getOpenFileAction());
    addKeyBinding("M+O", ActionManager.getInstance().getOpenFileAction());
    addKeyBinding("C+D", ActionManager.getInstance().getShowOptionsAction());
    addKeyBinding("M+D", ActionManager.getInstance().getShowOptionsAction());
   

    // Clipboard
    addKeyBinding("C+Z", ActionManager.getInstance().getUndoAction());
    addKeyBinding("M+Z", ActionManager.getInstance().getUndoAction());
    addKeyBinding("C+Y", ActionManager.getInstance().getRedoAction());
    addKeyBinding("M+Y", ActionManager.getInstance().getRedoAction());
    ...
    addKeyBinding("C+F", ActionManager.getInstance().getSearchAction());
    addKeyBinding("M+F", ActionManager.getInstance().getSearchAction());
    
    // Running
    
    addKeyBinding ("C+L", ActionManager.getInstance().getCompileAction());
    addKeyBinding ("M+L", ActionManager.getInstance().getCompileAction());
    
    addKeyBinding ("C+I", ActionManager.getInstance().getInterruptAction());
    addKeyBinding ("M+I", ActionManager.getInstance().getInterruptAction());
